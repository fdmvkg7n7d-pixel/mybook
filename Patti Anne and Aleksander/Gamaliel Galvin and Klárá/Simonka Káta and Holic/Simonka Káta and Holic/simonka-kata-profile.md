...
- [x] **Pregnancy refusal (saga-level canon).** Simonka uses her safeword **red** — for the first and possibly only time in her GG life — when informed of the breeding proposal involving Bruno and the third owner's $50,000 offer. She frames the decision as her **"hard red test,"** defining the creation of a child as the ultimate boundary of her participation. Holic respects this boundary immediately, rejecting the offer. *(Established in `Good Girl/the-hard-red-test-prose.md`.)*
