...
6. **Marcos Eduarte** same birth as the other triplets (~2061). *(Triplet.)*
7. **Annabella Nicki** same birth as the other triplets (~2061). *(Triplet, youngest.)*
...
- **The eggs are Jessica's.** Jessica donated her eggs to Rachel as a profound offering. Because Rachel cannot carry, the family works with three surrogates across the years:
  ...
  - **Bleu** carries the triplets, **Melissa Lizette**, **Marcos Eduarte**, and **Annabella Nicki** (~2061).
